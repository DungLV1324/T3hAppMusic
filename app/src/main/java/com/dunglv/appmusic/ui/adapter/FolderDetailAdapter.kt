...
import com.dunglv.appmusickl.databinding.ItemAllDetailFolderBinding

class FolderDetailAdapter :
    BaseBindingAdapter<Music, ItemAllDetailFolderBinding>(object : DiffUtil.ItemCallback<Music>() {
    ...
    override fun onBindViewHolderBase(
        holder: BaseHolder<ItemAllDetailFolderBinding>,
        position: Int
    ) {
    ...
    override val layoutIdItem = R.layout.item_all_detail_folder
}