...
import com.dunglv.appmusickl.databinding.ItemAllDetailSingBinding

class SingDetailAdapter :
    BaseBindingAdapter<Music, ItemAllDetailSingBinding>(object : DiffUtil.ItemCallback<Music>() {
    ...
    override fun onBindViewHolderBase(
        holder: BaseHolder<ItemAllDetailSingBinding>,
        position: Int
    ) {
    ...
    override val layoutIdItem = R.layout.item_all_detail_sing
}